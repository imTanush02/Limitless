...
const FixedUI = () => {
  ...
  // Nav → Dots transition (nav visible at start, dots on scroll)
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[1000] pointer-events-none font-sans text-white">
        ...
        <div ref={navRef} className="absolute top-10 right-10 xl:top-12 xl:right-14 2xl:top-14 2xl:right-16 pointer-events-auto flex flex-col text-right text-[10px] xl:text-[11px] tracking-[0.2em] gap-3 xl:gap-4">
          {["WORK", "PROCESS", "STUDIO", "CONTACT"].map((item, idx) => (
            <a key={idx} href="#" className="relative group overflow-hidden cursor-pointer block">
        ...
        <div className="absolute bottom-10 left-10 xl:bottom-12 xl:left-14 2xl:bottom-14 2xl:left-16 pointer-events-auto origin-bottom-left -rotate-90 flex items-center">
          ...
          <img src="/images/arrow.png" alt="" className="w-3 h-3 ml-1 rotate-90" />
        </div>

        {/* Bottom Right: Social Icons */}
        <div className="absolute bottom-10 right-10 xl:bottom-12 xl:right-14 2xl:bottom-14 2xl:right-16 pointer-events-auto flex flex-col gap-5 xl:gap-6 text-neutral-200">
          {/* Dribbble */}
      ...
      {/* ── Ticks layer: NO blend mode ── */}
      <div className="fixed inset-0 z-[1000] pointer-events-none font-sans text-white">
        {/* ── LEFT TICKS ── */}
        <div
          className="absolute left-10 xl:left-14 2xl:left-16 top-1/2 -translate-y-1/2 h-[300px]  2xl:h-[400px] pointer-events-auto"
        ...
        {/* ── RIGHT TICKS ── */}
        <div
          className="absolute right-10 xl:right-14 2xl:right-16 top-1/2 -translate-y-1/2 h-[300px]  2xl:h-[400px] pointer-events-auto"
